...
import LogoutUserController from '@/actions/App/Http/Controllers/Auth/LogoutUserController';
</script>
...
<template>
    ...
    >
        <!--
            Provisório: essa página inteira é o placeholder padrão do Laravel
